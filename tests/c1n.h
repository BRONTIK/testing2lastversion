...
TEST(c1n_tes2, test2) {
    ...
    char in[] = "tests/input/input_c1n_2.txt";
    char ou[] = "tests/output/output_c1n_2.txt";
    char ex[] = "tests/expected/expected_c1n_2.txt";
...
TEST(c1n_tes3, test3) {
    ...
    char in[] = "tests/input/input_c1n_3.txt";
    char ou[] = "tests/output/output_c1n_3.txt";
    char ex[] = "tests/expected/expected_c1n_3.txt";
